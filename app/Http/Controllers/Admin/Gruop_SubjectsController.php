...
class Gruop_SubjectsController extends Controller
{

    public function create(){
        return view('admin.group_sb.group_sb');
    }
    ...
    public function loadSubjects(){
        $subjects = DB::table('l_subject')->orderBy('num_subject', 'asc')->get();
        $json_data['data'] =  $subjects;
