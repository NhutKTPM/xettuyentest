...

{
    ...
    public function clear_check(){
        ...
        foreach ($cccd as $key => $value) {
            ...
            switch ($value->id_img) {
                case '2':
                    $newName = $value->id_user."_10.png";
                    $newFolder = "Lop10";
                    break;
                case '3':
                    $newName = $value->id_user."_11.png";
                    $newFolder = "Lop11";
                    break;
                case '4':
                    $newName = $value->id_user."_12.png";
                    $newFolder = "Lop12";
                    break;
                default:
                $newName = $value->id_user."_Dau.png";
                $newFolder = "TrangDau";
                    break;
            }
            if(File::exists($oldPath)){
                $path = public_path().'/img_orc/'.$newFolder;
                if(!File::exists($path)) {
            ...
            $newPathWithName = 'img_orc/'.$newFolder.'/'.$newName;
