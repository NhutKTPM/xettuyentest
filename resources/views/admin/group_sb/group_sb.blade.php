    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-md-12">
                <div class="card card-navy card-outline" style="height: 200px">
                    <div class="card-header" style="padding: 0;margin-left: 10px;font-weight: bold;">Thêm tổ hợp
                        {{-- <a style="margin-left: 10px;font-weight: bold;">Thêm năm xét tuyển</a> --}}
                    </div>

                    {{-- <div class="card-body" style=" padding: 3px">

                        <div class="card-body table-responsive p-0" style="margin-top: 1px">
                            <table class="table table-bordered table-hover"  class="display" style = 'width: 100%' id = 'loadGroups'>
            ...
            <div class="col-12 col-md-5">
                <div class="card card-navy card-outline">
                    <div class="card-header" style="padding: 0;margin-left: 10px;font-weight: bold;">Danh mục Môn học
                        {{-- <a style="margin-left: 10px;font-weight: bold;">Thêm năm xét tuyển</a> --}}
                    </div>
                    ...
                    <div class="card-body" style=" padding: 3px" >
                        ...
                        <div class="card-body table-responsive p-0" style="margin-top: 1px">
                            <table class="table table-bordered table-hover"  style = 'width: 100%' id = 'loadSubjects'>
            ...
            <div class="col-12 col-md-7">
                <div class="card card-navy card-outline">
                    <div class="card-header" style="padding: 0;margin-left: 10px;font-weight: bold;">Danh mục Tổ hợp
                        {{-- <a style="margin-left: 10px;font-weight: bold;">Thêm năm xét tuyển</a> --}}
                    </div>
    ...
    <script src="/admin/js/group_sb/control.js"></script>
