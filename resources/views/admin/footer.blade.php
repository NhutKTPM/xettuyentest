...
<footer class="main-footer">
    <strong>Trường Đại học Kỹ thuật - Công nghệ Cần Thơ &copy; since 2013 <a href="https://ctuet.edu.vn">CTUT</a>.</strong>
    <div class="float-right d-none d-sm-inline-block">
    <b>Phiên bản</b> 1.2.0 (tháng 03/2022)
    </div>
</footer>
...
<script src="/admin/js/main/r_control.js"></script>

{{-- <script src="/admin/js/users/control.js"></script> --}}
{{-- <script src="/admin/js/users/r_control.js"></script> --}}
