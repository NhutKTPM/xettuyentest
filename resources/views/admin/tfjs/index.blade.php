                    ...
                    <div class="card-body" style=" padding: 3px" >
                        <div class="row">
                            <div class="col-12 col-md-2">
                                {{-- <button type="button" id = "index_temp.blade" onclick="index_temp()" class="btn btn-block btn-primary btn-xs"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;&nbsp;Đăng nhập</button> --}}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="/admin/js/tf/data.js"  type="module"></script>
    <script src="/admin/js/tf/script.js"  type="module"></script>
