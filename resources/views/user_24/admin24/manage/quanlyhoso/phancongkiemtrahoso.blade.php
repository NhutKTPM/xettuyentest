                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                <div class="form-group row" style="margin-bottom: 3px">
                                    ...
                                    <div class="col-sm-10 col-md-9">
                                        <select class="form-control" id="phancongkiemtra_namtuyensinh" onchange="namtuyensinh_phancongkiemtra()" style="width: 100%;">
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                <div class="row">
                                    <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                       <button type="button" time = "" id="phancong_canboduyet" onclick="phancong_canbokiemtra()" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-user-check"></i>&nbsp;&nbsp;Phân công</button>
                                    </div>
                                    <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                        <button type="button" id="" onclick="lammoi_phancongkiemtra()" class="btn btn-block btn-primary btn-xs lammoi"><i class="fa-solid fa-rotate"></i>&nbsp;&nbsp;Làm mới</button>
                                    </div>
                                    <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-8">
                                <fieldset class="card card-body block-left" >
                                    <legend style="margin-bottom: -12px">Danh sách thí sinh</legend>
                                        <table class="table-bordered table-striped dataTable no-footer dtr-inline" id = "hosodanhsachkiemtra">
                                        </table>
                                </fieldset>
                            </div>
                            <div class="col-12 col-md-4 ">
                                <fieldset class="card card-body block-right">
                                    ...
                                    <table class="table-bordered table-striped dataTable no-footer dtr-inline" id = "ds_canbo_kiemtra">
                                    </table>
                                </fieldset>
                            </div>
                        </div>
