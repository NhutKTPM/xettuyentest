                                    ...
                                    <div class="card card-navy card-outline" style="min-height:600px">
                                        <div>
                                            ...
                                            <div class="card-body" style="padding-top: 3px; padding-bottom:0px">
                                                ...
                                                <div class="col-md-12 col-12" id="error_link" style="font-size: 13px; color : red;text-align: right;"></div>
                                                {{-- --}}
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group row" style="margin-bottom: 3px">
                                                ...
                                                <div class="col-md-12 col-12" id="error_icon" style="font-size: 13px; color : red;text-align: right;"></div>
                                                {{-- --}}
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group row" style="margin-bottom: 3px">
                                                ...
                                                <div class="col-md-12 col-12" id="error_stt" style="font-size: 13px; color : red;text-align: right;"></div>
                                                {{-- --}}
                                            </div>
                                        </div>
                        ...
                        <form id="editnsx">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="col-md-12 col-12" id ="error_update_tenmanhinh" style="font-size: 13px; color : red;text-align: right;"></div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="col-md-12 col-12" id ="error_update_icon" style="font-size: 13px; color : red;text-align: right;"></div>
                                </div>
                                {{--  --}}
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="col-md-12 col-12" id ="error_update_link" style="font-size: 13px; color : red;text-align: right;"></div>
                                </div>
                                ...
                                <div class="col-md-2 col-12">
                                    ...
                                    <div class="col-md-12 col-12" id ="error_update_stt" style="font-size: 13px; color : red;text-align: right;"></div>
                                </div>
                                {{-- <div class="col-md-12 col-12"> --}}
                                    <div class="card-header" style="padding: 0;margin-left: 10px;font-weight: bold;"></div>
                                    <div class="card-body" style="padding-top: 3px; padding-bottom:0px">
