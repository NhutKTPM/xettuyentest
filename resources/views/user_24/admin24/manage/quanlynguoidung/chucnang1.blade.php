                                    ...
                                    <div class="card" style="min-height:600px">
                                        <div>
                                            ...
                                            <div class="card-body" style="padding-top: 3px; padding-bottom:0px">
                                                ...
                                                <div class="col-md-12 col-12" id="error_settings_name" style="font-size: 13px; color : red;text-align: right;"></div>
                                                {{-- --}}
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group row" style="margin-bottom: 3px">
                                                ...
                                                <div class="col-md-12 col-12" id="error_manhinh" style="font-size: 13px; color : red;text-align: right;"></div>

                                                <div class="col-md-12 col-12" id="error_settings_link" style="font-size: 13px; color : red;text-align: right;"></div>
                                                {{-- --}}
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group row" style="margin-bottom: 3px">
                                                ...
                                                <div class="col-md-12 col-12" id="error_settings_note" style="font-size: 13px; color : red;text-align: right;"></div>
                                                {{-- --}}
                                                {{-- --}}
                                            </div>
                                        </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-8">
                                    <div class="card" style="min-height:600px">
                                        <div>
                                            ...
                                            <div class="card-body" style="padding-bottom: 0px;padding-top: 3px" id="ds_chucnang">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form id="editnsx">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        ...
                                        <div class="col-md-12 col-12" id ="error_update_tenchucnang" style="font-size: 13px; color : red;text-align: right;"></div>
                                    </div>
                                    {{--  --}}
                                    <div class="col-md-12 col-12">
                                        <div class="form-group row" style="margin-bottom: 3px">
                                        ...
                                        <div class="col-md-12 col-12" id ="error_update_chucnang_link" style="font-size: 13px; color : red;text-align: right;"></div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-12">
                                        ...
                                        <div class="col-md-12 col-12" id ="error_update_ghichu" style="font-size: 13px; color : red;text-align: right;"></div>
                                    </div>
                                    {{-- <div class="col-md-12 col-12"> --}}
                                        <div class="card-header" style="padding: 0;margin-left: 10px;font-weight: bold;"></div>
                                        <div class="card-body" style="padding-top: 3px; padding-bottom:0px">
