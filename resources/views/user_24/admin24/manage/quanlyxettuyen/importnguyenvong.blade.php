                                        ...
                                        <div class="card-body" style="padding-bottom: 0px;padding-top: 3px;height:455px" id="">
                                            {{-- <div class="item-thisinh"> --}}
                                                <div class="item-body" style="margin-top: 10px">
                                                    <div class = 'thongtin'>
                                                        <div class = "left">Import Nguyện vọng:</div>
                                                        <div>
                                                            <form style="display:none" id="submit_nguyenvongxettuyen">
                                                                <input type="file" name="nguyenvongxettuyen" id="nguyenvongxettuyen"/>
                                                            </form>
                                                        </div>
                                                        <i onclick="open_nguyenvongxettuyen()" class="fa-solid fa-file-excel"></i>&nbsp;&nbsp;
                                                        <i onclick="import_nguyenvongxettuyen()" class="fa fa-upload"></i>&nbsp;&nbsp;
                                                    </div>
                                                    <div class="item-bottom"></div>
                                                    <div class = 'thongtin'>
                                                        <div class = "left">Tính điểm xét tuyển:</div>
                                                    </div>

                                                    <div class="row" style="margin-top: 10px" >
                                                        <div class="col-md-12 col-12" style="margin-bottom: 5px">
                                                            <div class="form-group row" style="margin-bottom: 3px">
                                                                <label for="cal_start_id" class="col-sm-5 col-form-label" style="padding-bottom: 0px">Từ ID:</label>
                                                                <div class="col-sm-7">
                                                                    <input type="text" class="form-control" id="cal_start_id" style="height:28px;">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 col-12" style="margin-bottom: 5px">
                                                            <div class="form-group row" style="margin-bottom: 3px">
                                                                <label for="cal_end_id" class="col-sm-5 col-form-label" style="padding-bottom: 0px">Đến ID:</label>
                                                                <div class="col-sm-7">
                                                                    <input type="text" class="form-control" id="cal_end_id" style="height:28px;">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                        ...
                                                        <div class="col-8">
                                                            <button type="button"  style="width:100%;margin-top:6px" onclick="cal_nguyenvongxettuyen()" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-compass-drafting"></i>&nbsp;&nbsp;Tính điểm</button>
                                                        </div>
                                ...
                                <div class="col-12 col-md-10 col-lg-10">
                                    <div class="card" style="height: 605px">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 col-12" style="margin-bottom: 5px">
                                                    <div class="form-group row" >
                                                        <label for="import_nguyenvong" class="col-sm-2 col-md-3 col-form-label" style="padding-bottom: 0px;font-weight:bold">Đợt TS:</label>
                                                        <div class="col-sm-10 col-md-9">
                                                            <select class="form-control " id="import_nguyenvong"  style="width:100%;" >
                                                                ...
                                                                <option value="3">Xét tuyển bổ sung 2024 - Đọt 1</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-12" style="margin-bottom: 5px">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <button type="button"  style="width:100%" onclick="search_nguyenvongxettuyen()" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa fa-search"></i>&nbsp;&nbsp;Tìm kiếm</button>
                                                        </div>
                                                        <div class="col-6">
                                                            <button type="button"  style="width:100%" onclick="export_nguyenvongxettuyen()" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-regular fa-file-excel"></i>&nbsp;&nbsp;Xuất DS</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body" style="padding-bottom: 0px;padding-top: 10px;height:455px" id="remove_import_loadketquahoctap">
                                            <table class="table table-bordered table-hover table-striped dataTable no-footer dtr-inline" id="import_loadnguyenvongxettuyen"></table>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="/admin/admin24/js/quanlyxettuyen/importnguyenvong.js"></script>
