                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-12 col-lg-12">
                                    <div class="card" style="min-height: 605px">
                                                    ...
                                                    <div class="form-group row" >
                                                        ...
                                                        <div class="col-sm-10 col-md-9">
                                                            <select disabled class="form-control " id="thxt_dotts_xettuyen"  style="width:100%;" >
                                                                ...
                                                                <option value="1">Xét tuyển chung 2024</option>
                                                                <option value="2">Xét tuyển chung 2024</option>
                                                                <option selected = "selected" value="3">Xét tuyển chung 2024 - Bổ sung đợt 1</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row" >
                                                        ...
                                                        <div class="col-sm-10 col-md-9">
                                                            <select class="form-control" id="thxt_dotxt"  style="width:100%;" >
                                                                ...
                                                                <option value="1">Lọc ảo - Đợt 1</option>
                                                                <option value="2">Lọc ảo - Đợt 2</option>
                                                                {{-- <option value="2">Lọc ảo - Đợt 2</option>
                                                                <option value="3">Lọc ảo - Đợt 3</option>
                                                                <option value="4">Lọc ảo - Đợt 4</option>
                                                                <option value="5">Lọc ảo - Đợt 5</option>
                                                                <option value="6">Lọc ảo - Đợt 6</option>
                                                                <option value="7">Lọc ảo - Đợt 7</option>
                                                                <option value="8">Lọc ảo - Đợt 8</option>
                                                                <option value="9">Lọc ảo - Đợt 9</option>
                                                                <option value="10">Lọc ảo - Đợt 10</option>
                                                                <option value="11">Lọc ảo - Đợt 11</option>
                                                                <option value="12">Lọc ảo - Đợt 12</option> --}}
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <div class="col-4">
                                                                        <div class="row">
                                                                            <div class="col-4">
                                                                                ...
                                                                                <button type="button" id="danhsach_thisinh_locao" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-people-group"></i>&nbsp;&nbsp;DS Thí sinh</button>
                                                                            </div>
                                                                            <div class="col-4">
                                                                            ...
                                                                            <div class="col-4">
                                                                                <button type="button" id="thongkeketqualocao" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-chart-area"></i></i>&nbsp;&nbsp;Thống kê</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-4">
                                                                        <div class="row">
                                                                            ...
                                                                            <form style="display:none" id="submit_importketquanhom">
                                                                                <input type="file" name="ketquanhom" id="ketquanhom"/>
                                                                            </form>
                                                                            <div class="col-4">
                                                                            ...
                                                                            <form style="display:none" id="submit_importketquabo">
                                                                                <input type="file" name="ketquabo" id="ketquabo"/>
                                                                            </form>
                                                                            <div class="col-4">
                                                                                <button type="button" id="trungtuyenchinhthucdotts"  onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-regular fa-star"></i>&nbsp;&nbsp;Trúng tuyển</button>
                                                                                {{-- <button type="button" disabled id="phodiemtheodotts" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-compass-drafting"></i>&nbsp;&nbsp;Upload Bộ</button> --}}
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="card-body" style="padding-bottom: 0px;padding-top: 3px;margin-bottom:-30px;min-height:455px" id="">
                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-4">
                                                                            {{-- <button type="button" id="luudanhsachtrungtuyentam" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-compass-drafting"></i>&nbsp;&nbsp;Thêm đợt</button> --}}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-4">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-4">
                                                                            <button type="button" id="khoaxettuyendotts" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-key"></i>&nbsp;&nbsp;Khóa đợt TS</button>
                                                                        </div>
                                                                        <div class="col-4">
                                                                            <button type="button" id="congboketquatheodotxt" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-earth-americas"></i>&nbsp;&nbsp;Công bố</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-4">
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            <button type="button" disabled id="phodiemtheodotts" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-compass-drafting"></i>&nbsp;&nbsp;Gửi mail</button>
                                                                        </div>
                                                                        <div class="col-4">
                                                                        ...
                                                                        <div class="col-4">
                                                                            <button type="button" disabled id="phodiemtheodotts" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-compass-drafting"></i>&nbsp;&nbsp;In GBTT</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
