                        ...
                        <div class="col-md-12">
                            <div class="row">
                                        ...
                                        <div class="card-body" style="padding-bottom: 0px;padding-top: 3px;height:455px" id="">
                                            {{-- <div class="item-thisinh"> --}}
                                                <div class="item-body" style="margin-top: 10px">
                                                    <div class = 'thongtin'>
                                                        <div class = "left">Import tài khoản: </div>
                                                        <div>
                                                            <form style="display:none" id="submit_taikhoanthisinh">
                                                                <input type="file" name="taikhoanthisinh" id="taikhoanthisinh"/>
                                                            </form>
                                                        </div>
                                                        <i onclick="open_taikhoanthisinh()" class="fa-solid fa-file-excel"></i>&nbsp;&nbsp;
                                                        <i onclick="import_taikhoanthisinh()" class="fa fa-upload"></i>&nbsp;&nbsp;
                                                    </div>
                                                    <div class="item-bottom"></div>
                                                    <div class = 'thongtin'>
                                                        <div class = "left">Import TT thí sinh: </div>
                                                        <div>
                                                            <form  style="display:none" id="submit_thongtinthisinh">
                                                                <input type="file" name="thongtinthisinh" id="thongtinthisinh"/>
                                                            </form>
                                                        </div>
                                                        <i onclick="open_thongtinthisinh()" class="fa-solid fa-file-excel"></i>&nbsp;&nbsp;
                                                        <i onclick="import_thongtinthisinh()" class="fa fa-upload"></i>&nbsp;&nbsp;
                                                    </div>
                                                    <div class="item-bottom"></div>
                                                    <div class = 'thongtin'>
                                                        <div class = "left">Import KV Ưu tiên: </div>
                                                        <div>
                                                            <form  style="display:none" id="submit_khuvucuutien">
                                                                <input type="file" name="khuvucuutien" id="khuvucuutien"/>
                                                            </form>
                                                        </div>
                                                        <i onclick="open_khuvucuutien()" class="fa-solid fa-file-excel"></i>&nbsp;&nbsp;
                                                        <i onclick="import_khuvucuutien()" class="fa fa-upload"></i>&nbsp;&nbsp;
                                                    </div>
                                                    <div class="item-bottom"></div>
                                                    <div class = 'thongtin'>
                                                        <div class = "left">Import ĐT Ưu tiên: </div>
                                                        <div>
                                                            <form style="display:none" id="submit_doituonguutien">
                                                                <input type="file" name="doituonguutien" id="doituonguutien"/>
                                                            </form>
                                                        </div>
                                                        <i onclick="open_doituonguutien()" class="fa-solid fa-file-excel"></i>&nbsp;&nbsp;
                                                        <i onclick="import_doituonguutien()" class="fa fa-upload"></i>&nbsp;&nbsp;
                                                    </div>
                                                    <div class="item-bottom"></div>
                                                    <div class = 'thongtin'>
                                                        <div class = "left">Import Năm Tốt nghiệp: </div>
                                                        <div>
                                                            <form style="display:none" id="submit_namtotnghiep">
                                                                <input type="file" name="namtotnghiep" id="namtotnghiep"/>
                                                            </form>
                                                        </div>
                                                        <i onclick="open_namtotnghiep()" class="fa-solid fa-file-excel"></i>&nbsp;&nbsp;
                                                        <i onclick="import_namtotnghiep()" class="fa fa-upload"></i>&nbsp;&nbsp;
                                                    </div>
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <div class="">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-9">
                                                                        <button type="button"  style="width:100%" onclick="export_taikhoanthisinh()" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-regular fa-file-excel"></i>&nbsp;&nbsp;Xuất DS</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="col-12 col-md-9 col-lg-9">
                                    <div class="card" style="height: 605px">
                                        <div class="card-body" style="padding-bottom: 0px;padding-top: 10px;height:455px" id="">
                                            <table class="table table-bordered table-hover table-striped dataTable no-footer dtr-inline" id="import_loaddanhsachtaikhoan"></table>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="/admin/admin24/js/quanlyxettuyen/importdulieu.js"></script>
