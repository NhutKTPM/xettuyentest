                    ...
                    <div class="row">
                            ...
                            <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                <div class="form-group row" style="margin-bottom: 3px;margin-top: 10px">
                                    <label for="cccd_sv" class="col-2" style="padding-top: 5px;font-weight:bold">CCCD:</label>
                                    <div class="col-8">
                            ...
                            <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                <div class="form-group row" style="margin-bottom: 3px;margin-top: 10px">
                                    <label for="cccd_sv" class="col-2" style="padding-bottom: 0px;padding-top: 5px;font-weight:bold">Đợt:</label>
                                    <div class="col-10">
                                        <select style="width: 100%;height:33px;border:1px solid #ced4da;border-radius:.25rem" class="form-control" id="select_dot_phat" onchange="select_dot_phat()" style="width: 100%;">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <!-- button phát -->
                            <div style="margin-bottom: 3px;margin-top: 10px" class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                <button type="button" time="" data-id="" id="phat_dongphuc" onclick="phat_dongphuc()" class="btn btn-block btn-primary btn-xs">
                                    <i class="fa-solid fa-cart-shopping"></i>&nbsp;&nbsp;Phát sản phẩm
                                </button>
                            </div>
                        ...
                        <!-- <div class="style_all_button"></div> -->
                        <!-- </div> -->
                        <!-- <div class="card-body"> -->
                    </div>
                    <div class="card-body">
                        <div class="col-12 col-md-12">
                            <div class="row">
                                <div stlye="" class="col-3 col-md-3">
                                    <fieldset style="min-height:500px" class="card card-body">
                                        <legend  style="margin-bottom: 12px">Thông tin sinh viên</legend>
                                        <!-- Có thông tin sinh viên -->
                                        <div class="row">
                                            <div class=" col-md-12 col-12">
                                                <div class=" tt_sv row" style="margin-bottom: 3px" id="ten_sv">
                                                </div>
                                            </div>
                                            <div class=" col-md-12 col-12" >
                                                <div class="tt_sv row" style="margin-bottom: 3px" id="ngay_sinh">
                                                </div>
                                            </div>
                                            <div class=" col-md-12 col-12">
                                                <div class="row tt_sv" style="margin-bottom: 3px" id="cccd">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                ...
                                <div  class="col-9 col-md-9 col-lg-9">
                                    <fieldset style="min-height:500px" class="card card-body">
                                        ...
                                        <table class="table-bordered table-striped dataTable no-footer dtr-inline" id = "ds_dongphuc">
                                        </table>
                                    </fieldset>
                                </div>
                            </div>
