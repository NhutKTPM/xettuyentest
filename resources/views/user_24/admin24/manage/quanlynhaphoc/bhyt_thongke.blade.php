                                    ...
                                    <div class="col-md-12 col-12">
                                            <div class="form-group p-1" style="margin-bottom: 3px">
                                                ...
                                                <div class="col-sm-12  col-lg-12 col-xl-12 col-md-12 ">
                                                    <select class="form-control ttsv_info" id="major_bhyt_thongke" name = 'update_id_batch_search' style="width: 100%;"></select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-11 col-12">
                                            <div class="card-body p-1"> 
                                                <div class="row">                                         
                                                    ...
                                                    <button id="update_ttsv_search_bhyt_thongke"  id-data = "" class="btn btn-block btn-primary btn-xs " onclick="search_bhyt_thongke()"><i class="fa fa-search"></i>&nbsp;&nbsp;&nbsp;Tìm kiếm</button>
                                                    </div> 
                                                </div> 
                                            </div>                            
                                        </div>
                            ...
                            <div class="card card-primary card-outline card-outline-tabs" style="height:600px">                                                      
                                <div class="card-body" >
                                        <div class="tab-content" id="custom-tabs-two-tabContent">
                                            <table id = "table_thongtinsv_bhyt_thongke" class="table table-hover text-nowrap table-striped ">
                                                ...
                                                <div class="style_all_button">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="row">
                                                                <div class="col-6">
                                                                    {{-- <button type="button" id="dieutraketquatheodotxt" onclick="In()" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-print"></i>&nbsp;&nbsp; In </button> --}}
                                                                </div>
                                                                <div class="col-6">
                                                                    <button type="button" id="excel_hsnh_thongtinsinhvien_bhyt_thongke" onclick="" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-file-excel"></i>&nbsp;&nbsp;Excel</button>
                                                                </div>
...
<script src="/admin/admin24/js/bhyt_thongke.js"></script>