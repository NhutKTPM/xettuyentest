                                        ...
                                        <div class="card-body" style="padding-bottom: 0px;padding-top: 3px;height:455px" id="">
                                            {{-- <div class="item-thisinh"> --}}
                                                <div class="item-body" style="margin-top: 10px">
                                                    <div class = 'thongtin'>
                                                        <div class = "left">Import DS Xác nhận: </div>
                                                        <div>
                                                            <form  style="display:none" id="submit_importxacnhanbo">
                                                                <input type="file" name="importxacnhanbo" id="importxacnhanbo"/>
                                                            </form>
                                                        </div>
                                                        <i onclick="open_importxacnhanbo()" class="fa-solid fa-file-excel"></i>&nbsp;&nbsp;
                                                        <i onclick="import_importxacnhanbo()" class="fa fa-upload"></i>&nbsp;&nbsp;
                                                    </div>
...
<script src="/admin/admin24/js/quanlynhaphoc/importxacnhanbo.js"></script>
