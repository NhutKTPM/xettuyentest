       ...
       {{-- {{$mons}} --}}
        <div class="row">
            <div class="col-12 col-xl-8 col-md-12">
                ...
                <fieldset class="card card-body">
                    <legend>Điểm theo Tổ hợp xét tuyển</legend>
                    <div class="row">
                        @foreach ( $tophop as $value )
                        <div class="col-12 col-md-6 ">
                            <fieldset class="tohopthamkhao" style="min-height:auto;border:1px solid #dee2e6;border-radius:4px;margin-top:6px">
                                <legend style="color: #869099">{{$value->id_group}}: {{$value->name_group}}</legend>
                                <div style="margin:10px 0px 3px 0px;text-align:center">
                                    <span>Tổ hợp:</span> <span>{{$value->diemtohop}}</span>&nbsp;&nbsp;
                                    <span>Ưu tiên:</span> <span>{{$value->uutien}}</span>&nbsp;&nbsp;
                                    <span>Tổng điểm:</span> <span>{{$value->diemxettuyen}}</span>
                                </div>
                            </fieldset>
                        </div>
                        @endforeach
                    ...
                    <div class="row" style=" margin-top: 5px">
                        ...
                        <div class="col-md-2 col-12">
                            <button type="button" id = "tinhdiemthamkhao" onclick="tinhdiemthamkhao()" class="btn btn-block btn-primary btn-xs"><i class="fa-solid fa-calculator"></i>&nbsp;&nbsp;Tính điểm tham khảo</button>
                        </div>
                    </div>
                </fieldset>
            </div>
