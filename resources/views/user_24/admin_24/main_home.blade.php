        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
                    <div style="height:600px;" class="sale-statistic-inner notika-shadow mg-tb-30">
                        <canvas style="height:inherit;width:100%" id="bieudonguyenvong"></canvas>
                        {{-- <div id="line-chart" class="flot-chart flot-chart-sts"></div> --}}
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                    <div style="height:600px;" class="statistic-right-area notika-shadow mg-tb-30 sm-res-mg-t-0">
                        <div class="past-day-statis">
                            <h2>Tần suất truy cập</h2>
                            <p></p>
                        </div>
						<div class="dash-widget-visits"></div>
                        <div class="past-statistic-an">
                            <div class="past-statistic-ctn">
                                <h3><span class="counter">@if(empty($sldangnhap)) 0 @else {{$sldangnhap}} @endif</span></h3>
                                <p>SignIn Count</p>
                            </div>
                        ...
                        <div class="past-statistic-an">
                            <div class="past-statistic-ctn">
                                <h3><span class="">@if(empty($tiledangnhaplai)) 0% @else {{$tiledangnhaplai}} @endif</span> %</h3>
                                <p>RPR</p>
                            </div>
                            <div class="past-statistic-graph">
                        ...
                        <div class="past-statistic-an">
                            <div class="past-statistic-ctn">
                                <h3><span class="counter">@if(empty($tongclick)) 0 @else {{$tongclick}} @endif</span></h3>
                                <p>Total Click</p>
                            </div>
                            <div class="past-statistic-graph">
                                <div class="stats-bar-2"></div>
                        ...
                        <div class="past-statistic-an">
                            <div class="past-statistic-ctn">
                                <h3><span class="counter">@if(empty($taikhoan)) 0 @else {{$taikhoan}} @endif</span></h3>
                                <p>Accounts</p>
                            </div>
                            <div class="past-statistic-graph">
