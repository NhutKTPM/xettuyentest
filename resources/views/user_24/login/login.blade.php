...
<body class="hold-transition login-page">
    ...
    <div class="card">
        ...
        <form action="" method="">
            ...
            {{-- <div class="input-group mb-3">
                <input type="date" name = 'ngaysinh' id = 'ngaysinh' class="form-control validate_login"  placeholder="Ngày sinh"> --}}
                {{-- <div class="input-group-append">
                    <div class="input-group-text">
            ...
            <p class="mb-0">
                <a href="/" class="text-center" >Thí sinh nhập Căn cước công dân đúng theo Tài khoản đăng ký xét tuyển Bộ GD&ĐT</a>
            </p>
...
<script src="/user_24/js/tracuuketqua.js"></script>
