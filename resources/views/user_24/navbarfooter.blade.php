...
<footer class="main-footer menu" style="margin-left:0px;padding:0.2rem;overflow-y">
    {{-- background-color:#a3161d --}}
        ...
        {{-- <div class="menu4" style="">
            <a class="nav-link"   href="https://quanlyxettuyen.ctuet.edu.vn/dangkyxettuyen" role="button">
            <i class="fa fa-registered icon_menu"></i>
            <div class="text_menu_media" id = "">Đăng ký</div>
            <strong class="text_menu">Đăng ký nguyện vọng</strong>
            </a>
        </div> --}}
        ...
        <div class="menu5">
            ...
            {{-- <a class="nav-link"   href="https://quanlyxettuyen.ctuet.edu.vn/thanhtoanlephi" role="button">
                <i class="fa-solid fa-comments-dollar icon_menu"></i>
                <div class="text_menu_media" id = "">Lệ phí</div>
                <strong class="text_menu">Lệ phí xét tuyển</strong>
            </a> --}}
        </div>
