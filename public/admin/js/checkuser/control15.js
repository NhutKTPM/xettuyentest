...
function check_user_load_list_file_maphieu(id){
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            html += "<span><strong></strong>Mã phiếu trúng tuyển:&nbsp;&nbsp;&nbsp;</strong></span><span style ='color:#007bff;font-weight:bold'>"+res.maphieu+"</span><br>"
            html += "<span><strong></strong>Trạng thái trúng tuyển:&nbsp;&nbsp;&nbsp;</strong></span><span style ='color:#007bff;font-weight:bold'>"+res.tt+"</span><br>"
            html += "<span><strong></strong>Xác nhận cổng Trường:&nbsp;&nbsp;&nbsp;</strong></span><span style ='color:#007bff;font-weight:bold'>"+res.xn+"<br>"
            html += "<span><strong></strong>Mã phiếu rà soát:&nbsp;&nbsp;&nbsp;</strong></span><span style ='color:#007bff;font-weight:bold'>"+res.rs+"</span><br></br>"
