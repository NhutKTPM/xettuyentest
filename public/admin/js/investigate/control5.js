            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data){
                        var data = data.split('-')
                        if(data[0] == 1){
                            return "<input onchange =luutrangthai("+data[1]+")  id ='luutrangthai"+data[1]+"' value = 'Nhập học' style = 'width: 100%;heght: 100%'>"
                        }else{
                            if(data[0] == 2){
                                return "<input onchange =luutrangthai("+data[1]+")  id ='luutrangthai"+data[1]+"' value = 'Không học' style = 'width: 100%;heght: 100%'>"
                            }else{
                                if(data[0] == 3){
                                    return "<input onchange =luutrangthai("+data[1]+")  id ='luutrangthai"+data[1]+"' value = 'Không liên lạc được' style = 'width: 100%;heght: 100%'>"
                                }else{
                                    return "<input onchange =luutrangthai("+data[1]+")  id ='luutrangthai"+data[1]+"' value = '' style = 'width: 100%;heght: 100%'>"
                                }
                            }
                        }
                    }
