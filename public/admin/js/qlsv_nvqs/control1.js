...
function nvqs_print_nvqs(){
    ...
    // window.location.href = "https://quanlyxettuyen.ctuet.edu.vn/admin/qlsv_nvqs/nvqs_print_nvqs"+'/'+major+'/'+nvqs_id_card+'/'+nvqs_mssv+'/'+load_admin_sig

    window.open('https://quanlyxettuyen.ctuet.edu.vn/admin/qlsv_nvqs/nvqs_print_nvqs'+'/'+major+'/'+nvqs_id_card+'/'+nvqs_mssv+'/'+load_admin_sig,'_blank')

    window.open('https://xettuyentest.ctuet.edu.vn/admin/qlsv_nvqs/nvqs_print_nvqs'+'/'+major+'/'+nvqs_id_card+'/'+nvqs_mssv+'/'+load_admin_sig,'_blank')
...
function list_nvqs(){
    ...
    if(major == 0){
        toastr.warning("Chọn đợt ngành sinh")
    }else{
        var data;
        data = [major,nvqs_id_card,nvqs_mssv]
