            ...
            success: function (r) {
                ...
                for (let i = 0; i<r.length; i++){
                    ...
                    if(r[i].reg_all == 0 || r[i].reg_pas == 0){
                        ...
                        var tl_ct = Math.round(r[i].reg_pas/r[i].min_major* 1000)/10
                    }
                    html += '<td style = "text-align: center">'+tl_ct+'</td>';
                    html += '<td class = "reg_pas_nv1_tts" style = "text-align: center">'+r[i].reg_pas_nv1_tts+'</td>';
                    html += '<td class = "reg_pas_nv1" style = "text-align: center">'+r[i].reg_pas_nv1+'</td>';
                    html += '<td class = "reg_pas_nv2_tts" style = "text-align: center">'+r[i].reg_pas_nv2_tts+'</td>';
                    html += '<td class = "reg_pas_nv2" style = "text-align: center">'+r[i].reg_pas_nv2+'</td>';
                    html += '<td class = "reg_pas_nv3_tts" style = "text-align: center">'+r[i].reg_pas_nv3_tts+'</td>';
                    ...
                    if(r[i].min_major_hb == 0 || r[i].reg_tts_pas == 0){
                        ...
                        var tl_hb_tts = Math.round(r[i].reg_tts_pas/r[i].min_major_hb* 1000)/10
                    }
                    ...
                    if(r[i].min_major_hb == 0 || r[i].reg_hb_dkm_pas == 0){
                        ...
                        var tl_hb_dkm = Math.round(r[i].reg_hb_dkm_pas/r[i].min_major_hb* 1000)/10
                    }
                    ...
                    if(r[i].min_major_hb == 0 || r[i].reg_hb_pas == 0){
                        ...
                        var tl_hb = Math.round(r[i].reg_hb_pas/r[i].min_major_hb* 1000)/10
                    }
                    ...
                    if(r[i].min_major_thpt == 0 || r[i].reg_thpt_pas == 0){
                        ...
                        var tl_thpt = Math.round(r[i].reg_thpt_pas/r[i].min_major_thpt* 1000)/10
                    }
                    ...
                    if(r[i].min_major_nl == 0 || r[i].reg_tts_nl_pas == 0){
                        ...
                        var tl_nl_tts = Math.round(r[i].reg_tts_nl_pas/r[i].min_major_nl* 1000)/10
                    }
                    ...
                    if(r[i].min_major_nl == 0 || r[i].reg_nl_dkm_pas == 0){
                        ...
                        var tl_nl_dkm = Math.round(r[i].reg_nl_dkm_pas/r[i].min_major_nl* 1000)/10
                    }
                    ...
                    if(r[i].min_major_nl == 0 || r[i].reg_nl_pas == 0){
                        ...
                        var tl_nl = Math.round(r[i].reg_nl_pas/r[i].min_major_nl* 1000)/10
                    }
                ...
                html += "<tr>";
                    ...
                    html += '<td class = "reg_pas_nv1_tts_sum" style = "text-align: right;font-weight: bold"></td>';
                    html += '<td class = "reg_pas_nv1_sum" style = "text-align: right;font-weight: bold"></td>';
                    html += '<td class = "reg_pas_nv2_tts_sum" style = "text-align: right;font-weight: bold"></td>';
                    html += '<td class = "reg_pas_nv2_sum" style = "text-align: right;font-weight: bold"></td>';
                    html += '<td class = "reg_pas_nv3_tts_sum" style = "text-align: right;font-weight: bold"></td>';
                ...
                setTimeout(() => {
                    ...
                    if(sumArray(min_major) == 0 || sumArray(reg_pas) ==0){
                        ...
                        var tl_sum = Math.round(sumArray(reg_pas)/sumArray(min_major)*1000)/10
                    }
                    $('.tl_sum').text(tl_sum)

                    var reg_pas_nv1_tts = document.getElementsByClassName('reg_pas_nv1_tts')
                    $('.reg_pas_nv1_tts_sum').text(sumArray(reg_pas_nv1_tts))
                    var reg_pas_nv1 = document.getElementsByClassName('reg_pas_nv1')
                    $('.reg_pas_nv1_sum').text(sumArray(reg_pas_nv1))
                    var reg_pas_nv2_tts = document.getElementsByClassName('reg_pas_nv2_tts')
                    $('.reg_pas_nv2_tts_sum').text(sumArray(reg_pas_nv2_tts))
                    var reg_pas_nv2 = document.getElementsByClassName('reg_pas_nv2')
                    $('.reg_pas_nv2_sum').text(sumArray(reg_pas_nv2))
                    var reg_pas_nv3_tts = document.getElementsByClassName('reg_pas_nv3_tts')
                    $('.reg_pas_nv3_tts_sum').text(sumArray(reg_pas_nv3_tts))
                    ...
                    if(sumArray(min_major_hb) == 0 || sumArray(reg_tts_pas) ==0){
                        ...
                        var tl_hb_tts_sum = Math.round(sumArray(reg_tts_pas)/sumArray(min_major_hb)*1000)/10
                    }
                    ...
                    if(sumArray(min_major_hb) == 0 || sumArray(reg_hb_dkm_pas) == 0){
                        ...
                        var tl_hb_dkm_sum = Math.round(sumArray(reg_hb_dkm_pas)/sumArray(min_major_hb)*1000)/10
                    }
                    $('.tl_hb_dkm_sum').text(tl_hb_dkm_sum)
                    ...
                    if(sumArray(min_major_hb) == 0 || sumArray(reg_hb_pas) ==0){
                        ...
                        var tl_hb = Math.round(sumArray(reg_hb_pas)/sumArray(min_major_hb)*1000)/10
                    }
                    ...
                    if(sumArray(min_major_thpt) == 0 || sumArray(reg_thpt_pas) ==0){
                        ...
                        var tl_thpt = Math.round(sumArray(reg_thpt_pas)/sumArray(min_major_thpt)*1000)/10
                    }
                    ...
                    if(sumArray(min_major_nl) == 0 || sumArray(reg_tts_nl_pas) == 0){
                        ...
                        var tl_nl_tts = Math.round(sumArray(reg_tts_nl_pas)/sumArray(min_major_nl)*1000)/10
                    }
                    ...
                    if(sumArray(min_major_nl) == 0 || sumArray(reg_nl_dkm_pas) == 0){
                        ...
                        var tl_nl_dkm = Math.round(sumArray(reg_nl_dkm_pas)/sumArray(min_major_nl)*1000)/10
                    }
                    ...
                    if(sumArray(min_major_nl) == 0 || sumArray(reg_nl_pas) ==0){
                        ...
                        var tl_nl = Math.round(sumArray(reg_nl_pas)/sumArray(min_major_nl)*1000)/10
                    }
...
function go_virtual_chart_major(id){
    ...
    // $('#go_virtual_chart_major').append('<canvas id="add_go_virtual_chart_major" style="min-height: 450px; height: 450px; max-height: 450px; max-width: 10%;"></canvas>');
            ...
            success: function (res) {
                switch (res) {
                    case '2':
                        ...
                        break;
                    default:
                        var major = [], pass_tr1 = [], pass_tr2 = [],pass_tr3 = [], pass_nhom1 = [], pass_nhom2 = [],pass_nhom3 = [], pass_bo1= [], pass_bo2= [],pass_bo3= []
                        for(let i = 0;i<res.length;i++){
                            major[i] = res[i]['id_batch']
                            pass_tr1[i] = res[i]['pass_tr1']
                            pass_tr2[i] = res[i]['pass_tr2']
                            pass_tr3[i] = res[i]['pass_tr3']

                            pass_nhom1[i] = res[i]['pass_nhom1']
                            pass_nhom2[i] = res[i]['pass_nhom2']
                            pass_nhom3[i] = res[i]['pass_nhom3']

                            pass_bo1[i] = res[i]['pass_bo1']
                            pass_bo2[i] = res[i]['pass_bo2']
                            pass_bo3[i] = res[i]['pass_bo3']
