$(document).ready(function(){
    ...
    $('#ex_list_go').on('click',function(){
        ex_list_go();
    })

    $('#ex_list_student').on('click',function(){
        ex_list_student();
    })

    $('#ex_list_wish').on('click',function(){
        ex_list_wish();
    })

    $('#ex_list_wish_fail').on('click',function(){
        ex_list_wish_fail();
    })

    $('#ex_list_fail').on('click',function(){
        ex_list_fail();
    })
        ...
        $.ajax({
            ...
            success: function (r) {
                ...
                for (let i = 0; i<r.length; i++){
                    ...
                    html += '<td class = "reg_all_ct" style = "text-align: center">'+r[i].reg_all_ct+'</td>';
                    ...
                    html += '<td class = "reg_hb1_ct" style = "text-align: center">'+r[i].reg_hb1_ct+'</td>';
                    ...
                    html += '<td class = "reg_hb2_ct" style = "text-align: center">'+r[i].reg_hb2_ct+'</td>';
                    ...
                    html += '<td class = "reg_nl_ct" style = "text-align: center">'+r[i].reg_nl_sum_ct+'</td>';
                ...
                html += "<tr>";
                    ...
                    html += '<td class = "reg_all_sum_ct" style = "text-align: right;font-weight: bold"></td>';
                    ...
                    html += '<td class = "reg_hb1_sum_ct" style = "text-align: right;font-weight: bold"></td>';
                    ...
                    html += '<td class = "reg_hb2_sum_ct" style = "text-align: right;font-weight: bold"></td>';
                    ...
                    html += '<td class = "reg_nl_sum_ct" style = "text-align: right;font-weight: bold"></td>';
                ...
                setTimeout(() => {
                    ...
                    var reg_all_ct = document.getElementsByClassName('reg_all_ct')
                    $('.reg_all_sum_ct').text(sumArray(reg_all_ct))
                    var reg_hb1_ct = document.getElementsByClassName('reg_hb1_ct')
                    $('.reg_hb2_sum_ct').text(sumArray(reg_hb1_ct))
                    var reg_hb1_ct = document.getElementsByClassName('reg_hb2_ct')
                    $('.reg_hb2_sum_ct').text(sumArray(reg_hb1_ct))
                    var reg_nl_ct = document.getElementsByClassName('reg_nl_ct')
                    $('.reg_nl_sum_ct').text(sumArray(reg_nl_ct))
...
function ex_list_wish(){
    // window.location.href = "https://xettuyentest.ctuet.edu.vn/admin/go/ex_list_wish"
    window.location.href = "https://quanlyxettuyen.ctuet.edu.vn/admin/go/ex_list_wish"

}

function ex_list_wish_fail(){
    // window.location.href = "https://xettuyentest.ctuet.edu.vn/admin/go/ex_list_wish_fail"
    window.location.href = "https://quanlyxettuyen.ctuet.edu.vn/admin/go/ex_list_wish_fail"

}

function ex_list_fail(){
    // window.location.href = "https://xettuyentest.ctuet.edu.vn/admin/go/ex_list_fail"
    window.location.href = "https://quanlyxettuyen.ctuet.edu.vn/admin/go/ex_list_fail"
